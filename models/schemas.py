...
#     if SchemaRepository.check_user(user_name):
#         return user_name
...
class TaskSchema(BaseModel):
    ...
    #executor: Annotated[str, AfterValidator(check_user)] | None = Field(default=None, description='Task executor / Ответственный за выполнение задачи')
